...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- NOTE: Gruvbox is set as default below; tokyonight available via <leader>to
  ...
  -- require 'kickstart.plugins.neo-tree', -- Disabled: using enhanced version from custom/plugins
